...
template<typename FloatType, int TensDim, typename InputType, typename Store >
void SoftMaxLayer<FloatType,TensDim,InputType,Store>::deriv(Vector<FloatType> &cost_deriv, int off, Tensor<FloatType,TensDim> &&above_deriv_, InputType* input_above_deriv_return) const{
